...
#	oc = ObjectContainer()
#
#	oc.add(DirectoryObject(key = Callback(getShows), title="Shows"))
#	
#	return oc
#
####################################################################################################
...
def getVideos(url):
	...
	#<div class="c-overlay"><h3>EPISODE 1</h3>			
	
	content = HTML.ElementFromURL(url)
	for video in content.xpath('//div[@class="eps-container"]'):
		#Log.Debug(video)
		# time = get time
		thumb 	= BASE + video.xpath('./img')[0].get('src')
		link	= BASE + video.xpath('./div[@class="eps-actions"]/a')[0].get('href')
		title	= video.xpath('./div[@class="eps-actions"]/a')[0].text
		title 	= title.replace('  ', '')
		Log.Debug(title)
...
#	<span class="timestamp">01:03</span>
#	<img src="/images/uploads/shows/12/61/.tmb/thumb_weird-creatures-mudskipper-earth-touch-poster_adaptiveResize_268_124.jpg" alt="" />			
#	<div class="eps-actions">
#		<div class="locked-dark ir active" title="This video is open.">locked</div>
#			<a href="/shows/weird-creatures/weird-creatures-mudskipper/" class="eps-play">Play episode 2</a>
#			<hr />			                    
#			<a class="seeall dark wl showContentWL61 " href="#watchlater" onclick="toggleWatchEpisodeLater('showContentWL61', 61);">watch later</a>
#				<div class="heart">
#					<a href="#love" class="episodeFavourite heart-icon ir showContentFav61 " onclick="toggleEpisodeIsFavourite('showContentFav61', 61);">love</a>
#					<p>1</p>
#				</div>		                    
#		</div>	
